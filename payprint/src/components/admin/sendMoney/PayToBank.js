...
import { dataSelectPayToBank } from '../../../utils/data'
...
import ReceiverDetails from './payToBank/ReceiverDetails'
import ReceiverList from './topUp/ReceiverList'
import Transaction from './topUp/Transaction'

function PayToBank() {
  const [select, setSelect] = useState(dataSelectPayToBank[0])
  const query = new URLSearchParams(useLocation().search);
  const { path } = useRouteMatch();
  const receiverList = [
    {
      name: 'John Smith',
      img: dataSelectPayToBank[0]
    },
  ];
  return (
    <Fragment>
            ...
            <div className="column content-credit-card">
              ...
              <div className="detail-payment-policy">
                ...
                <div className="has-text-right">
                  <Link to="/admin/send-money/payment-successful?from=pay-to-bank">
