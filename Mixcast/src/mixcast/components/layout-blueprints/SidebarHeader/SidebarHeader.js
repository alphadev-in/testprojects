...
import projectLogo2021 from '../../../../assets/images/mixcast2021logo.svg';
    ...
    <>
      <div className="app-sidebar--header">
        <div className="app-sidebar-logo">
          <NavLink to="/mixcast" title="Mixcast" className="app-sidebar-logo">
            {/* <div className="app-sidebar-logo--icon"> */}
            <div>
              <img alt="Mixcast" src={projectLogo2021} style={{ width: 220 }} />
            </div>
